...
export const NIGERIA_STATES: NgState[] = [
  {
    id: 303,
    name: "Abia",
    code: "AB",
    lgas: [
      ...
      "Isiala Ngwa South", "Isuikwuato", "Umu Nneochi", "Obi Ngwa", "Ohafia",
  ...
  },
  {
    ...
    lgas: [
      ...
      "Ijebu North East", "Ijebu Ode", "Ikenne", "Imeko Afon", "Ipokia", "Obafemi Owode",
...
export const getStateByName = (name: string): NgState | undefined =>
  NIGERIA_STATES.find((s) => s.name === name);

export const getStateById = (id: number): NgState | undefined =>
  NIGERIA_STATES.find((s) => s.id === id);

export const getLgasByStateName = (stateName: string): string[] =>
  NIGERIA_STATES.find((s) => s.name === stateName)?.lgas ?? [];

export const getLgasByStateId = (stateId: number): string[] =>
  NIGERIA_STATES.find((s) => s.id === stateId)?.lgas ?? [];